...
function updateFilters() {
  ...
  // ADDITIONAL function to reset filters back to empty - reload page
...
// instead of selecting just the updated filters based on events, take all and remove the empty keys
// filter the table based on remaining elements
// remember data in table is all lower case, so save value as lowercase() or may not match
// need to add back in filter data button
// d3.select("#filter-btn").on("click", updateFilters);   

// change the UpdateFilters to include:
